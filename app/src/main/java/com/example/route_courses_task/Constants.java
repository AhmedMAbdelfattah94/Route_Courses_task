...
public interface Constants {
    ...
    String ANDROID_COURSE = "android";
    String IOS_COURSE = "ios";
    String FULLSTACK_COURSE = "fullstack";
    String ANDROID_DETAIL_TEXT = "Part 1 ( Java SE)\n" +
    ...
    String IOS_DETAIL_TEXT = "OOP refreshment\n" +
            "• Introduction\n" +
    ...
    String FULLSTACK_DETAIL_TEXT = "•HTML\t\n" +
            "•HTML 5 \n" +
            "•CSS\n" +
            "•CSS3\n" +
            "•SASS\n" +
